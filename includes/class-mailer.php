...
class TTB_Mailer {
  ...
  /* ─────────────────────────────────────────────
     HELPER: pills de servicios
  ───────────────────────────────────────────── */
  private function build_pills($services, $map, $icons) {
    $pills = '';
...
<tr><td align="center">
  <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:20px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.12)">
        ...
        <table width="100%" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:22px 24px">
              <p style="margin:0 0 14px;font-size:13px;font-weight:900;color:' . $pink . ';text-transform:uppercase;letter-spacing:.08em">
                🔐 Tus datos de acceso
              </p>
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:6px 0">
                    <code style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:4px 10px;font-size:14px;color:#1a1a2e;font-weight:700">' . esc_html($password) . '</code>
                  </td>
                </tr>
              </table>
            </td>
    ...
    <tr>
      <td align="center" style="background:#1a1a2e;padding:24px 32px">
        <p style="margin:0 0 6px;font-size:13px;color:rgba(255,255,255,.5)">© ' . date('Y') . ' TicTac Comunicación Digital</p>
          ...
          <tr>
            <td style="padding:22px 24px">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="font-size:13px;font-weight:700;color:#6b7280;padding:6px 0">Password</td>
                  <td style="padding:6px 0">
                    <code style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:4px 10px;font-size:14px;color:#1a1a2e;font-weight:700">' . esc_html($password) . '</code>
                  </td>
                </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:18px 22px">
              ...
              <p style="margin:0;font-size:15px;color:#1a1a2e"><strong>Servicio:</strong> ' . esc_html($dept) . '</p>
            </td>
          </tr>
        </table>
            ...
            <td align="center" style="padding-bottom:12px">
              <a href="' . esc_url($portal_url) . '" target="_blank" rel="noopener"
                 style="display:inline-block;background:linear-gradient(135deg,' . $pink . ' 0%,#a8005a 100%);
                        ...
                        padding:14px 36px;border-radius:12px;box-shadow:0 8px 20px rgba(215,33,115,.30)">
            ...
            <td align="center">
              <a href="' . esc_url($drive_url) . '" target="_blank" rel="noopener"
                 style="display:inline-block;background:#ffffff;
                        color:#1a1a2e;text-decoration:none;font-weight:900;font-size:15px;
                        padding:14px 36px;border-radius:12px;
                        border:2px solid #e5e7eb;box-shadow:0 4px 12px rgba(0,0,0,.06)">
